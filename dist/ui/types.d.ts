...
export interface WatchedAuthorOption {
    label: string;
    value: string | null;
    custom: boolean;
}
...
export interface AppState {
    ...
    viewScrollState: Partial<Record<string, {
        selectedRowIndex: number;
        tableScrollOffset: number;
    }>>;
...
export type Action = {
    ...
    type: "SET_TABLE_SCROLL";
    offset: number;
} | {
    type: "SET_OVERLAY";
    overlay: ActiveOverlay;
} | {
    type: "SET_SECURITY_SORT";
    sort: SecuritySortMode;
} | {
    type: "UPDATE_ATTENTION_STATE";
    state: TrackedAttentionState;
    itemCount: number;
} | {
    ...
    type: "SET_QUEUED_REFRESH";
    target: ViewKey | "all" | null;
} | {
    type: "ADD_LOADED_VIEW";
    key: ViewKey;
} | {
    ...
    type: "APPEND_NEEDS_MY_REVIEW";
    pullRequests: PullRequestSummary[];
    hasMore: boolean;
    nextCursor: string | null;
} | {
    type: "APPEND_WATCHED_AUTHOR";
    pullRequests: PullRequestSummary[];
    hasMore: boolean;
    nextCursor: string | null;
} | {
    ...
    type: "SET_REPO_LIST_INDEX";
    index: number;
} | {
    type: "OPEN_REPO_DETAIL";
    repo: string;
} | {
    ...
    type: "SET_REPO_DETAIL_PRS";
    prs: PullRequestSummary[];
} | {
    type: "SET_REPO_DETAIL_PRS_LOADING";
    value: boolean;
} | {
